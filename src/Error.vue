    ...
    <section id="services" class="services">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="section-title">
          <h2>Error</h2>
          <p>email me if you need any help<br>infomuscle10@gmail.com</p>
        </div>

        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6 d-flex justify-content-center align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue my-5">
              <div class="icon">
